...
// Fetch attendance data from statistics.php logic
require_once 'statistics.php'; // Include the statistics.php file

// Get the attendance data using the statistics.php functions
$attendanceData = getEmployeeAttendanceData($employeeId, $selectedMonth, $selectedYear);

// Public holidays (example for 2024-2025)
$publicHolidays = [
...
// Populate log data from statistics.php results
foreach ($days as &$day) {
    if (isset($attendanceData[$day['full_date']])) {
        $log = $attendanceData[$day['full_date']];
