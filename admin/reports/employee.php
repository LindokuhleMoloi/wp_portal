...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button type="button" class="btn btn-flat btn-warning" id="stick"><span class="fas fa-thumbtack"></span> Stick</button>
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        $qry = $conn->query("SELECT l.*, e.fullname, e.department_id, e.designation_id, e.employee_code, e.date_updated 
                                             FROM `logs` l 
                                ...
                                <td class="text-center">
                                    <?php if($row['type'] == 1): ?>
                                        ...
                                        <?php elseif($row['type'] == 3): ?>
                                         <span class="badge custom-yellow rounded-pill">WFH</span>
                                    <?php else: ?>
