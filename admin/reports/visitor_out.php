        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        ...
                        $qry = $conn->query("SELECT * FROM `visitor_out` {$where}");
                        ...
                        ?>
                            <tr>
								...
								<td class="text-right"><?php echo date("Y-m-d H:i",strtotime($row['date_Out'])) ?></td>
								<td class="text-center"><?php echo htmlspecialchars($row['viscode']); ?></td>
								<td class="text-center"><?php echo htmlspecialchars($row['name']); ?></td>
								<td>
									<p class="m-0">
										<small>
											<span class="text-muted">Contact #: </span><span><?php echo htmlspecialchars($row['contact']); ?></span><br>
										</small>
									</p>
								</td>
