...
if(isset($_GET['id'])){
    ...
    $employer_qry = $conn->query("SELECT * FROM employer_list WHERE id IN (SELECT employer_id FROM employee_list WHERE id = '{$_GET['id']}')");
    ...
    if($qry->num_rows > 0){
        ...
        $employer = isset($employer_arr[$employer_id]) ? $employer_arr[$employer_id] : "N/A";  // Set employer variable
    }
}
?>
<div class="card card-outline card-primary">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl>
                        ...
                        <dt class="text-info">Employer:</dt>
                        <dd class="fw-bold pl-3"><?php echo isset($employer) ? $employer : "" ?></dd>
                    </dl>
                </div>
                <div class="col-md-6">
                    <dl>
  ...
  <a class="btn btn-flat btn-sn btn-dark" href="index.php?page=employee<?php echo isset($_GET['current_page']) ? '&current_page='.urlencode($_GET['current_page']) : '' ?>">Back to List</a>
    </div>
</div>
<script>
    $(function(){
